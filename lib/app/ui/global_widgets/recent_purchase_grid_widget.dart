...
class RecentPurchaseGridWidget extends StatelessWidget {
  final List<Beneficiary> beneficiaries;
  final void Function() onAdd;
  final void Function(int) onDelete;

  const RecentPurchaseGridWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return GridView(
      ...
      children: [
        ...beneficiaries.mapIndexed((idx, bf) => beneficiaryTile(bf, idx)),
        addBeneficiary(),
      ],
    );
  }
  ...
  Widget beneficiaryTile(Beneficiary beneficiary, int index) {
    return Column(
