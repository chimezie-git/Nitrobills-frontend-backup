...
class GbCableServiceProviderModal extends StatelessWidget {
  const GbCableServiceProviderModal({super.key});
  ...
  Widget planListTile(TvServiceProvider provider) {
    return InkWell(
      onTap: () {
        _select(provider);
      },
  ...
  void _select(TvServiceProvider provider) {
